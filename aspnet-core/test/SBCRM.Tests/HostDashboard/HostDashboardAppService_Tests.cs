...
using SBCRM.MultiTenancy.HostDashboard;
...
namespace SBCRM.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(SBCRMDbContext context, SubscriptionPayment subscriptionPayment)
        {
