...
using SBCRM.Authorization.Ldap;
...
using SBCRM.DynamicEntityProperties;
...
using SBCRM.WebHooks;
using Newtonsoft.Json;

namespace SBCRM
{
    [DependsOn(
        typeof(SBCRMCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class SBCRMCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            SBCRMLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = SBCRMConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, SBCRMMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<SBCRMSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(SBCRMCoreModule).GetAssembly());
        }
