...
namespace SBCRM.Authorization
{
    ...
    public class AppAuthorizationProvider : AuthorizationProvider
    {
        ...
        public override void SetPermissions(IPermissionDefinitionContext context)
        {
            ...
            opportunities.CreateChildPermission(AppPermissions.Pages_Opportunities_AutomateAssignment__Dynamic, L("AutomateAssignmentUser"));
            ...
            leads.CreateChildPermission(AppPermissions.Pages_Leads_AutomateAssignment__Dynamic, L("AutomateAssignmentUser"));
