...
namespace SBCRM.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : SBCRMServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("SBCRM", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
