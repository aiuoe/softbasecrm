...
{
    [Table("ARImagesDeleted", Schema = "web")]
    [Index(nameof(TenantId), Name = "ARImagesDeleted_TenantId_index")]
    public class ArimagesDeleted : FullAuditedEntity<long>, IMustHaveTenant
    {
        [StringLength(50)]
