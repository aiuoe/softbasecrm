...
{
    [Table("EQCustomLabels", Schema = "web")]
    [Index(nameof(TenantId), Name = "EQCustomLabels_TenantId_index")]
    [Index(nameof(SerialNo), nameof(TenantId), Name = "UC_EQCustomLabels", IsUnique = true)]
    public class EqcustomLabel : FullAuditedEntity<long>, IMustHaveTenant
    {
        [Required]
        [StringLength(100)]
