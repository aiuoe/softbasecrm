...
using SBCRM.DemoUiComponents.Dto;

namespace SBCRM.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : SBCRMAppServiceBase, IDemoUiComponentsAppService
    {
