...
using SBCRM.Features;

namespace SBCRM.Sessions
{
    public class SessionAppService : SBCRMAppServiceBase, ISessionAppService
    {
            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                var output = new GetCurrentLoginInformationsOutput
                {
                    Application = new ApplicationInfoDto
                    {
                        ...
                        Currency = SBCRMConsts.Currency,
                        CurrencySign = SBCRMConsts.CurrencySign,
                        AllowTenantsToChangeEmailSettings = SBCRMConsts.AllowTenantsToChangeEmailSettings,
