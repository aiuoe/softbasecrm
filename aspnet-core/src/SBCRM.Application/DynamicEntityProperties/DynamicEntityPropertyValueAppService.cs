...
using SBCRM.DynamicEntityPropertyValues.Dto;

namespace SBCRM.DynamicEntityProperties
{
    [AbpAuthorize(AppPermissions.Pages_Administration_DynamicEntityPropertyValue)]
    public class DynamicEntityPropertyValueAppService : SBCRMAppServiceBase, IDynamicEntityPropertyValueAppService
    {
