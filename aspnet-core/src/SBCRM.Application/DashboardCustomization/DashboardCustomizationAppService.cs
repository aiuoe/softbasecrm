...
using SBCRM.DashboardCustomization.Definitions;
using SBCRM.DashboardCustomization.Dto;
using Newtonsoft.Json;

namespace SBCRM.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : SBCRMAppServiceBase, IDashboardCustomizationAppService
    {
