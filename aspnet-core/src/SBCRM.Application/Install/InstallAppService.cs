...
using SBCRM.Install.Dto;
using SBCRM.Migrations.Seed;
using SBCRM.Migrations.Seed.Host;
using Newtonsoft.Json;
using Newtonsoft.Json.Linq;

namespace SBCRM.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : SBCRMAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<SBCRMDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{SBCRMConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{SBCRMConsts.ConnectionStringName}", constring);
        }
