...
using SBCRM.Auditing.Exporting;
using SBCRM.Authorization;
using SBCRM.Authorization.Users;
using SBCRM.Dto;
using SBCRM.EntityHistory;
using EntityHistoryHelper = SBCRM.EntityHistory.EntityHistoryHelper;

namespace SBCRM.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : SBCRMAppServiceBase, IAuditLogAppService
    {
