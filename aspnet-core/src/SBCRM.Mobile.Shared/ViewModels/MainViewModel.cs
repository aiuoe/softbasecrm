...
using SBCRM.Services.Navigation;
...
using SBCRM.ApiClient;
using SBCRM.Controls;
using SBCRM.Dto;
using SBCRM.Extensions;
using SBCRM.Localization;
using SBCRM.UI;
using SBCRM.UI.Assets;
using SBCRM.Views;
using DependencyResolver = SBCRM.Core.Dependency.DependencyResolver;
...
namespace SBCRM.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "SBCRM";
