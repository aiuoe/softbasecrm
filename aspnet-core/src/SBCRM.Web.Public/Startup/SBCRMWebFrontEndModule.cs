...
namespace SBCRM.Web.Public.Startup
{
    [DependsOn(
        typeof(SBCRMWebCoreModule)
    )]
    public class SBCRMWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public SBCRMWebFrontEndModule(IWebHostEnvironment env, SBCRMEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(SBCRMWebFrontEndModule).GetAssembly());
        }
    }
}
