...
using SBCRM.Url;
using SBCRM.Web.Public.Startup;
using SBCRM.Web.Session;

namespace SBCRM.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : SBCRMViewComponent
    {
