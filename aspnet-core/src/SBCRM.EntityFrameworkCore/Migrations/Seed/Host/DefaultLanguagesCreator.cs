...
namespace SBCRM.Migrations.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly SBCRMDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = SBCRMConsts.MultiTenancyEnabled ? null : (int?)1;
        ...
        public DefaultLanguagesCreator(SBCRMDbContext context)
        {
            _context = context;
        }
