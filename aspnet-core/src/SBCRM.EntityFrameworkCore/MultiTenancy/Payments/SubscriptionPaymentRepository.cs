...
{
    public class SubscriptionPaymentRepository : SBCRMRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<SBCRMDbContext> dbContextProvider)
