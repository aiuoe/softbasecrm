...
using SBCRM.Startup;
using SBCRM.Web.Authentication.JwtBearer;
using SBCRM.Web.Authentication.TwoFactor;
using SBCRM.Web.Chat.SignalR;
using SBCRM.Web.Common;
using SBCRM.Web.Configuration;
using SBCRM.Web.DashboardCustomization;
...
namespace SBCRM.Web
{
    ...
    public class SBCRMWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public SBCRMWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(SBCRMApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(SBCRMWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(SBCRMWebCoreModule).Assembly);
        }
