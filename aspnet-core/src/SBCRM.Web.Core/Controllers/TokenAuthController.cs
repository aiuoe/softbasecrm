...
using SBCRM.Authentication.TwoFactor.Google;
...
using SBCRM.Web.Models.TokenAuth;
using SBCRM.Authorization.Impersonation;
...
using SBCRM.Web.Authentication.External;
...
namespace SBCRM.Web.Controllers
{
    ...
    public class TokenAuthController : SBCRMControllerBase
    {
