...
using SBCRM.Web.Startup.ExternalLoginInfoProviders;
...
namespace SBCRM.Web.Startup
{
    ...
    public class SBCRMWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public SBCRMWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(SBCRMWebHostModule).GetAssembly());
        }
