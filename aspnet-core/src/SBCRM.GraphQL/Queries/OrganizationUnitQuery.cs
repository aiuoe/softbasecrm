...
using SBCRM.Core.Base;
using SBCRM.Core.Extensions;
using SBCRM.Dto;
using SBCRM.Types;

namespace SBCRM.Queries
{
    public class OrganizationUnitQuery : SBCRMQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
